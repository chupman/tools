...
def GetRTData():
    res = requests.get("http://racktables-host/racktables/api.php?method=get_depot&andor=and&cft%5B%5D=15&cfe=%7B%24typeid_1504%7D&include_attrs=1", auth=HTTPBasicAuth('user', 'password'))
    rtdata = res.json()
